...
const navigation = {
  ...
  social: [
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/HarmonyBatiment/',
      icon: (props: any) => (
    ...
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/harmony_batiment/',
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: 'LinkedIn',
      href: 'https://www.linkedin.com/company/harmony-b%C3%A2timent/',
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
      ...
      <div className="container py-12 md:py-16">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            <span className="text-2xl font-bold text-white">Harmony batiment</span>
            <p className="text-sm leading-6 text-gray-300">
Votre projet mérite l’excellence.
Avec Harmony Bâtiment, bénéficiez d’un savoir-faire reconnu mêlant tradition du bâtiment et technologies actuelles.            </p>
        ...
        <div className="mt-12 border-t border-white/10 pt-8">
          <p className="text-xs leading-5 text-gray-400">&copy; {new Date().getFullYear()}Harmony batiment. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
